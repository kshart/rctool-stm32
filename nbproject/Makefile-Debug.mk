...
${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/rctool-stm32.exe: ${OBJECTFILES}
	...
	arm-none-eabi-gcc -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/rctool-stm32 ${OBJECTFILES} ${LDLIBSOPTIONS} -TSTM32F103C6Tx_FLASH.ld -specs=nano.specs -mcpu=cortex-m3 -mthumb -Wl,--gc-sections -specs=nosys.specs -u _printf_float
...
${OBJECTDIR}/src/core/PackageBuffer.o: src/core/PackageBuffer.cpp
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -DSTM32F103x6 -DUSE_HAL_DRIVER -IDrivers/STM32F1xx_HAL_Driver/Inc -IDrivers/STM32F1xx_HAL_Driver/Inc/Legacy -IDrivers/CMSIS/Device/ST/STM32F1xx/Include -IDrivers/CMSIS/Include -Isrc -Isrc/core -include stdint.h -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/core/PackageBuffer.o src/core/PackageBuffer.cpp

${OBJECTDIR}/src/core/PackageManager.o: src/core/PackageManager.cpp
	${MKDIR} -p ${OBJECTDIR}/src/core
	${RM} "$@.d"
	$(COMPILE.cc) -g -DSTM32F103x6 -DUSE_HAL_DRIVER -IDrivers/STM32F1xx_HAL_Driver/Inc -IDrivers/STM32F1xx_HAL_Driver/Inc/Legacy -IDrivers/CMSIS/Device/ST/STM32F1xx/Include -IDrivers/CMSIS/Include -Isrc -Isrc/core -include stdint.h -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/core/PackageManager.o src/core/PackageManager.cpp

${OBJECTDIR}/src/core/gpio.o: src/core/gpio.c
	${MKDIR} -p ${OBJECTDIR}/src/core
	${RM} "$@.d"
	$(COMPILE.c) -g -DSTM32F103x6 -DUSE_HAL_DRIVER -IDrivers/STM32F1xx_HAL_Driver/Inc -IDrivers/STM32F1xx_HAL_Driver/Inc/Legacy -IDrivers/CMSIS/Device/ST/STM32F1xx/Include -IDrivers/CMSIS/Include -Isrc -Isrc/core -std=c11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/core/gpio.o src/core/gpio.c

${OBJECTDIR}/src/core/stm32f1xx_hal_msp.o: src/core/stm32f1xx_hal_msp.c
	${MKDIR} -p ${OBJECTDIR}/src/core
	${RM} "$@.d"
	$(COMPILE.c) -g -DSTM32F103x6 -DUSE_HAL_DRIVER -IDrivers/STM32F1xx_HAL_Driver/Inc -IDrivers/STM32F1xx_HAL_Driver/Inc/Legacy -IDrivers/CMSIS/Device/ST/STM32F1xx/Include -IDrivers/CMSIS/Include -Isrc -Isrc/core -std=c11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/core/stm32f1xx_hal_msp.o src/core/stm32f1xx_hal_msp.c

${OBJECTDIR}/src/core/stm32f1xx_it.o: src/core/stm32f1xx_it.c
	${MKDIR} -p ${OBJECTDIR}/src/core
	${RM} "$@.d"
	$(COMPILE.c) -g -DSTM32F103x6 -DUSE_HAL_DRIVER -IDrivers/STM32F1xx_HAL_Driver/Inc -IDrivers/STM32F1xx_HAL_Driver/Inc/Legacy -IDrivers/CMSIS/Device/ST/STM32F1xx/Include -IDrivers/CMSIS/Include -Isrc -Isrc/core -std=c11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/core/stm32f1xx_it.o src/core/stm32f1xx_it.c

${OBJECTDIR}/src/core/system_stm32f1xx.o: src/core/system_stm32f1xx.c
	${MKDIR} -p ${OBJECTDIR}/src/core
	${RM} "$@.d"
	$(COMPILE.c) -g -DSTM32F103x6 -DUSE_HAL_DRIVER -IDrivers/STM32F1xx_HAL_Driver/Inc -IDrivers/STM32F1xx_HAL_Driver/Inc/Legacy -IDrivers/CMSIS/Device/ST/STM32F1xx/Include -IDrivers/CMSIS/Include -Isrc -Isrc/core -std=c11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/core/system_stm32f1xx.o src/core/system_stm32f1xx.c

${OBJECTDIR}/src/core/tim.o: src/core/tim.c
	${MKDIR} -p ${OBJECTDIR}/src/core
	${RM} "$@.d"
	$(COMPILE.c) -g -DSTM32F103x6 -DUSE_HAL_DRIVER -IDrivers/STM32F1xx_HAL_Driver/Inc -IDrivers/STM32F1xx_HAL_Driver/Inc/Legacy -IDrivers/CMSIS/Device/ST/STM32F1xx/Include -IDrivers/CMSIS/Include -Isrc -Isrc/core -std=c11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/core/tim.o src/core/tim.c

${OBJECTDIR}/src/core/usart.o: src/core/usart.c
	${MKDIR} -p ${OBJECTDIR}/src/core
	${RM} "$@.d"
	$(COMPILE.c) -g -DSTM32F103x6 -DUSE_HAL_DRIVER -IDrivers/STM32F1xx_HAL_Driver/Inc -IDrivers/STM32F1xx_HAL_Driver/Inc/Legacy -IDrivers/CMSIS/Device/ST/STM32F1xx/Include -IDrivers/CMSIS/Include -Isrc -Isrc/core -std=c11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/core/usart.o src/core/usart.c

${OBJECTDIR}/src/hc05/hc05.o: src/hc05/hc05.c
	${MKDIR} -p ${OBJECTDIR}/src/hc05
	${RM} "$@.d"
	$(COMPILE.c) -g -DSTM32F103x6 -DUSE_HAL_DRIVER -IDrivers/STM32F1xx_HAL_Driver/Inc -IDrivers/STM32F1xx_HAL_Driver/Inc/Legacy -IDrivers/CMSIS/Device/ST/STM32F1xx/Include -IDrivers/CMSIS/Include -Isrc -Isrc/core -std=c11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/hc05/hc05.o src/hc05/hc05.c

${OBJECTDIR}/src/main.o: src/main.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -g -DSTM32F103x6 -DUSE_HAL_DRIVER -IDrivers/STM32F1xx_HAL_Driver/Inc -IDrivers/STM32F1xx_HAL_Driver/Inc/Legacy -IDrivers/CMSIS/Device/ST/STM32F1xx/Include -IDrivers/CMSIS/Include -Isrc -Isrc/core -include stdint.h -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/main.o src/main.cpp

${OBJECTDIR}/startup_stm32f103x6.o: startup_stm32f103x6.s
	${MKDIR} -p ${OBJECTDIR}
	$(AS) $(ASFLAGS) -g -o ${OBJECTDIR}/startup_stm32f103x6.o startup_stm32f103x6.s
